...
public class Rpc {
   ...
   * <p>
   * Note that if you are using the `BaseNexusChat` JavaScript class
  ...
  /**
   * Get QR code text that will offer a [SecureJoin](https://securejoin.nexus.chat/) invitation.
   * <p>
   ...
   * to Nexus Chat's developers.
   * <p>
   * **source**: The source where the QR code came from.
   * E.g. a link that was clicked inside or outside Nexus Chat,
