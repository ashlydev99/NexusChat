...
import org.thoughtcrime.securesms.preferences.FontSettingsFragment;
...
public class ApplicationPreferencesActivity extends PassphraseRequiredActionBarActivity
  ...
  private static final String PREFERENCE_CATEGORY_FONTS = "preference_category_fonts";
  ...
  public static class ApplicationPreferenceFragment extends CorrectedPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
      ...
      this.findPreference(PREFERENCE_CATEGORY_FONTS)
          .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_FONTS));
    ...
    private String getFontSummary() {
      String selectedFont = Prefs.getStringPreference(getActivity(), "selected_font", "default");
      switch (selectedFont) {
        case "sans_serif": return "Sans Serif (Roboto)";
        case "serif": return "Serif";
        case "monospace": return "Monospace";
        case "roboto": return "Roboto";
        default: return "Predeterminada del sistema";
      }
    }
      ...
      public boolean onPreferenceClick(Preference preference) {
        ...
        switch (category) {
          ...
          case PREFERENCE_CATEGORY_APPEARANCE:
            ...
            break;
          case PREFERENCE_CATEGORY_FONTS:
            fragment = new FontSettingsFragment();
            break;
