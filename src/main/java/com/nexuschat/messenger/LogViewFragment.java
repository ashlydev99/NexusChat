...
public class LogViewFragment extends Fragment {
  ...
  public File saveLogFile(File outputDir) {
    ...
    Date now = new Date();
    String logFileName = "nexuschat-log-" + dateFormat.format(now) + ".txt";
  ...
  private static String buildDescription(LogViewFragment fragment) {
    ...
    final Rpc rpc = NcHelper.getRpc(context);
    final int accId = NcHelper.getContext(context).getAccountId();
    ...
    builder.append(NcHelper.getContext(context).getInfo());
