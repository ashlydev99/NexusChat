...
import static com.nexuschat.messenger.ConversationActivity.FROM_ARCHIVED_CHATS_EXTRA;
...
public class ConversationListArchiveActivity extends PassphraseRequiredActionBarActivity
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (itemId == android.R.id.home) {
      ...
      NcHelper.getContext(this).marknoticedChat(NcChat.NC_CHAT_ID_ARCHIVED_LINK);
      return true;
    }
