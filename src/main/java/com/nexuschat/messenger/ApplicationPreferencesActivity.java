...
import com.nexuschat.messenger.preferences.AdvancedPreferenceFragment;
import com.nexuschat.messenger.preferences.AppearancePreferenceFragment;
import com.nexuschat.messenger.preferences.ChatsPreferenceFragment;
import com.nexuschat.messenger.preferences.CorrectedPreferenceFragment;
import com.nexuschat.messenger.preferences.NotificationsPreferenceFragment;
import com.nexuschat.messenger.preferences.widgets.ProfilePreference;
...
public class ApplicationPreferencesActivity extends PassphraseRequiredActionBarActivity
  ...
  public static class ApplicationPreferenceFragment extends CorrectedPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
      ...
      NcHelper.getEventCenter(getActivity())
          .addObserver(NcContext.NC_EVENT_CONNECTIVITY_CHANGED, this);
    }
    ...
    public void handleEvent(@NonNull NcEvent event) {
      if (event.getId() == NcContext.NC_EVENT_CONNECTIVITY_CHANGED) {
        this.findPreference(PREFERENCE_CATEGORY_CONNECTIVITY)
            .setSummary(
                NcHelper.getConnectivitySummary(
      ...
      public boolean onPreferenceClick(Preference preference) {
        ...
        switch (category) {
          ...
          case PREFERENCE_CATEGORY_DONATE:
            IntentUtils.showInBrowser(requireActivity(), "https://nexus.chat/donate");
            break;
