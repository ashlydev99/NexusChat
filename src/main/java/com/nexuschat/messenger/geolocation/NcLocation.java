...
public class DcLocation extends Observable {
  private static final String TAG = NcLocation.class.getSimpleName();
  private Location lastLocation;
  private static NcLocation instance;
  ...
  public static NcLocation getInstance() {
    if (instance == null) {
      instance = new NcLocation();
    }
    return instance;
  }
  ...
  private boolean isBetterLocation(Location location, Location currentBestLocation) {
    ...
    boolean isSignificantlyOlder = timeNexus < -TIMEOUT;
    ...
    int accuracyNexus = (int) (location.getAccuracy() - currentBestLocation.getAccuracy());
    ...
    boolean isMoreAccurate = accuracyNexus > 0;
