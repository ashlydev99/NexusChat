...
public class AllMediaActivity extends PassphraseRequiredActionBarActivity
  ...
  protected void onCreate(Bundle bundle, boolean ready) {
    tabs.add(new TabData(R.string.webxnc_apps, NcMsg.NC_MSG_WEBXNC, 0, 0));
    tabs.add(
        new TabData(
            R.string.tab_gallery, NcMsg.NC_MSG_IMAGE, NcMsg.NC_MSG_GIF, NcMsg.NC_MSG_VIDEO));
    tabs.add(new TabData(R.string.audio, NcMsg.NC_MSG_AUDIO, NcMsg.NC_MSG_VOICE, 0));
    tabs.add(new TabData(R.string.files, NcMsg.NC_MSG_FILE, 0, 0));
  ...
  private class AllMediaPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
      ...
      if (data.type1 == NcMsg.NC_MSG_IMAGE) {
