 ...
 */
package com.nexuschat.messenger.database.model;
...
public class ThreadRecord {
  ...
  private @Nullable final NcLot ncSummary;
  ...
  public SpannableString getDisplayBody() {
    if (ncSummary != null && ncSummary.getText1Meaning() == NcLot.NC_TEXT1_DRAFT) {
      String draftText = ncSummary.getText1() + ":";
      return emphasisAdded(draftText + " " + ncSummary.getText2(), 0, draftText.length());
    } else {
