...
public class AllMediaGalleryFragment extends MessageSelectorFragment
  ...
  public Loader<BucketedThreadMediaLoader.BucketedThreadMedia> onCreateLoader(
    ...
    return new BucketedThreadMediaLoader(
        getContext(), chatId, NcMsg.NC_MSG_IMAGE, NcMsg.NC_MSG_GIF, NcMsg.NC_MSG_VIDEO);
  }
  ...
  private void handleMediaPreviewClick(@NonNull NcMsg mediaRecord) {
    ...
    intent.putExtra(MediaPreviewActivity.NC_MSG_ID, mediaRecord.getId());
