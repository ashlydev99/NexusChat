...
import com.nexuschat.messenger.imageeditor.ImageEditorMediaConstraints;
import com.nexuschat.messenger.imageeditor.ImageEditorView;
import com.nexuschat.messenger.imageeditor.Renderer;
import com.nexuschat.messenger.imageeditor.model.EditorElement;
import com.nexuschat.messenger.imageeditor.model.EditorModel;
import com.nexuschat.messenger.imageeditor.renderers.MultiLineTextRenderer;
import com.nexuschat.messenger.mms.MediaConstraints;
import com.nexuschat.messenger.providers.PersistentBlobProvider;
import com.nexuschat.messenger.scribbles.widget.VerticalSlideColorPicker;
import com.nexuschat.messenger.util.MediaUtil;
import com.nexuschat.messenger.util.ParcelUtil;
...
public final class ImageEditorFragment extends Fragment
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (resultCode == RESULT_OK && requestCode == SELECT_STICKER_REQUEST_CODE && data != null) {
      ...
      UriGlideRenderer renderer =
          new UriGlideRenderer(
              Uri.parse("file:///android_asset/" + stickerFile),
              false,
              imageMaxWidth,
              imageMaxHeight);
      EditorElement element = new EditorElement(renderer);
