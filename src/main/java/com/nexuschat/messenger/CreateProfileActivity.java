...
public class CreateProfileActivity extends BaseActionBarActivity {
  ...
  private void initializeProfileName() {
    String profileName = NcHelper.get(this, NcHelper.CONFIG_DISPLAY_NAME);
  ...
  private void initializeStatusText() {
    String status = NcHelper.get(this, NcHelper.CONFIG_SELF_STATUS);
  ...
  private void setStatusText() {
    ...
    NcHelper.set(this, NcHelper.CONFIG_SELF_STATUS, newStatus);
  }
