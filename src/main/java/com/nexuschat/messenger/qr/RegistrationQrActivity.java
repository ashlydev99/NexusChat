...
public class RegistrationQrActivity extends BaseActionBarActivity {
  ...
  private void showConfirmDialog(
    ...
    String dialogMsg = "";
    if (qrParsed.getState() == NcContext.NC_QR_ASK_VERIFYCONTACT) {
    ...
    } else if (qrParsed.getState() == NcContext.NC_QR_ASK_VERIFYGROUP) {
      String groupName = qrParsed.getText1();
      dialogMsg = getString(R.string.instant_onboarding_confirm_group, groupName);
    }

    if (qrParsed.getState() == NcContext.NC_QR_ASK_VERIFYCONTACT
        || qrParsed.getState() == NcContext.NC_QR_ASK_VERIFYGROUP) {
