...
public class BackupTransferActivity extends BaseActionBarActivity {
  ...
  protected void onCreate(Bundle icicle) {
    ...
    NcHelper.getAccounts(this).stopIo();
  ...
  public boolean onOptionsItemSelected(@NonNull MenuItem item) {
    ...
    if (itemId == android.R.id.home) {
      ...
      NcHelper.openHelp(this, "#multiclient");
      return true;
  ...
  public void setTransferError(@NonNull String errorContext) {
    if (this.transferState != TransferState.TRANSFER_ERROR) {
      ...
      String lastError = NcHelper.getContext(this).getLastError();
  ...
  public void doFinish() {
    ...
    if (transferMode == TransferMode.RECEIVER_SCAN_QR
      ...
      // (we removed the activity backstack as otherwise a tap on the Nexus Chat icon on the home
      // screen would
      ...
      // (the user can leave Nexus Chat during backup transfer :)
