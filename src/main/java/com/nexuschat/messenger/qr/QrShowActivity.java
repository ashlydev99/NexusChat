...
public class QrShowActivity extends BaseActionBarActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fragment =
        (QrShowFragment) getSupportFragmentManager().findFragmentById(R.id.qrScannerFragment);
    ...
    ncEventCenter = NcHelper.getEventCenter(this);
    ...
    if (chatId != 0) {
      // verified-group
      String groupName = ncContext.getChat(chatId).getName();
      ...
      if (selfName.isEmpty()) {
        selfName = NcHelper.get(this, NcHelper.CONFIG_CONFIGURED_ADDRESS, "unknown");
      }
