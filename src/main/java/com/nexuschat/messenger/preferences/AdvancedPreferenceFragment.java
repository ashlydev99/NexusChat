...
import static com.nexuschat.messenger.connect.DcHelper.CONFIG_BCC_SELF;
import static com.nexuschat.messenger.connect.DcHelper.CONFIG_MVBOX_MOVE;
import static com.nexuschat.messenger.connect.DcHelper.CONFIG_ONLY_FETCH_MVBOX;
import static com.nexuschat.messenger.connect.DcHelper.CONFIG_SHOW_EMAILS;
import static com.nexuschat.messenger.connect.DcHelper.CONFIG_STATS_SENDING;
...
import com.nexuschat.messenger.LogViewActivity;
import com.nexuschat.messenger.R;
import com.nexuschat.messenger.StatsSending;
...
import com.nexuschat.messenger.util.StreamUtil;
...
public class AdvancedPreferenceFragment extends ListSummaryPreferenceFragment
  ...
  public void onResume() {
    ...
    String value = Integer.toString(ncContext.getConfigInt("show_emails"));
    showEmails.setValue(value);
    updateListSummary(showEmails, value);

    selfReportingCheckbox.setChecked(0 != ncContext.getConfigInt(CONFIG_STATS_SENDING));
    multiDeviceCheckbox.setChecked(0 != ncContext.getConfigInt(CONFIG_BCC_SELF));
    mvboxMoveCheckbox.setChecked(0 != ncContext.getConfigInt(CONFIG_MVBOX_MOVE));
    onlyFetchMvboxCheckbox.setChecked(0 != ncContext.getConfigInt(CONFIG_ONLY_FETCH_MVBOX));
  }
