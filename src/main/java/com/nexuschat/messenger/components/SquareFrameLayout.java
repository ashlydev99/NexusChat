  ...
  public SquareFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (attrs != null) {
      try (TypedArray typedArray =
          context.getTheme().obtainStyledAttributes(attrs, R.styleable.SquareFrameLayout, 0, 0)) {
        this.squareHeight =
            typedArray.getBoolean(R.styleable.SquareFrameLayout_square_height, false);
      }
    } else {
