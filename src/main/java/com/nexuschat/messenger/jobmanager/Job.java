 ...
 */
package com.nexuschat.messenger.jobmanager;

import android.os.PowerManager;
import java.io.Serializable;
import com.nexuschat.messenger.jobmanager.requirements.Requirement;

/**
 * An abstract class representing a unit of work that can be scheduled with the JobManager. This
 * should be extended to implement tasks.
 */
public abstract class Job implements Serializable {
  ...
  /**
   * Called after a job has been added to the JobManager queue. If it's a persistent job, the state
   * has been persisted to disk before this method is called.
   */
  ...
  /**
   * If onRun() throws an exception, this method will be called to determine whether the job should
   * be retried.
   *
