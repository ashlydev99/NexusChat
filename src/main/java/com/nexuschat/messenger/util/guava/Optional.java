...
package com.nexuschat.messenger.util.guava;

import static com.nexuschat.messenger.util.guava.Preconditions.checkNotNull;
 ...
 *       (though there are <a
 *       href="http://code.google.com/p/guava-libraries/wiki/LivingWithNullHostileCollections">
 ...
 * href="http://code.google.com/p/guava-libraries/wiki/UsingAndAvoidingNullExplained#Optional">using
 * {@code Optional}</a>.
 *
...
public abstract class Optional<T> implements Serializable {
   ...
   * {@link Optional#absent} is returned. If the function returns {@code null}, a {@link
