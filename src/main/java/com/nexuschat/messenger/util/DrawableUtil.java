...
public final class DrawableUtil {
  ...
  private static final int SHORTCUT_INFO_PADDING =
      (SHORTCUT_INFO_BITMAP_SIZE - SHORTCUT_INFO_WRAPPED_SIZE) / 2;

  public static @NonNull Bitmap wrapBitmapForShortcutInfo(@NonNull Bitmap toWrap) {
    Bitmap bitmap =
        Bitmap.createBitmap(
            SHORTCUT_INFO_BITMAP_SIZE, SHORTCUT_INFO_BITMAP_SIZE, Bitmap.Config.ARGB_8888);
    Bitmap scaled =
        Bitmap.createScaledBitmap(
            toWrap, SHORTCUT_INFO_WRAPPED_SIZE, SHORTCUT_INFO_WRAPPED_SIZE, true);
