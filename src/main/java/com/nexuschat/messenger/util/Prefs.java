...
public class Prefs {
  ...
  public static boolean isHardCompressionEnabled(Context context) {
    return NcHelper.getContext(context).getConfigInt(NcHelper.CONFIG_MEDIA_QUALITY)
        == NcContext.NC_MEDIA_QUALITY_WORSE;
  }
  ...
  public static boolean reliableService(Context context) {
    ...
    return !isPushEnabled(context) || !NcHelper.getAccounts(context).isAllChatmail();
  }
