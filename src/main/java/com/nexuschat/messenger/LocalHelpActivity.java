...
public class LocalHelpActivity extends WebViewActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (itemId == R.id.log_scroll_up) {
      ...
      openOnlineUrl("https://nexus.chat");
      return true;
    } else if (itemId == R.id.privacy_policy) {
      openOnlineUrl("https://nexus.chat/gdpr");
      return true;
    } else if (itemId == R.id.contribute) {
      openOnlineUrl("https://nexus.chat/contribute");
      return true;
    } else if (itemId == R.id.report_issue) {
      openOnlineUrl("https://github.com/ashlydev99/NexusChat/issues");
      return true;
    }
    return false;
  }
