...
class DrawingSession extends ElementEditSession {
  ...
  private DrawingSession(
      ...
      @NonNull BezierDrawingRenderer renderer) {
    super(selected, inverseMatrix);
    this.renderer = renderer;
  }

  public static EditSession start(
      EditorElement element, BezierDrawingRenderer renderer, Matrix inverseMatrix, PointF point) {
