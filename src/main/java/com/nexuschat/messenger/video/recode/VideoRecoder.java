package com.nexuschat.messenger.video.recode;
...
public class VideoRecoder {
  ...
  public static boolean prepareVideo(Context context, int chatId, NcMsg msg) {
    final long MAX_BYTES = NcHelper.getInt(context, "sys.msgsize_max_recommended");
    ...
    try {
      ...
      // recode
      String tempPath = NcHelper.getBlobdirFile(NcHelper.getContext(context), inPath);
