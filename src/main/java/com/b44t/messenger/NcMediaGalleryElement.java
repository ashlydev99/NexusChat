...
public class NcMediaGalleryElement {

  final int[] mediaMsgs;
  int position;
  final NcContext context;

  public NcMediaGalleryElement(
      int[] mediaMsgs, int position, NcContext context, boolean leftIsRecent) {
