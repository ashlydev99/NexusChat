...
public class NcProvider {
  ...
  public static final int NC_PROVIDER_STATUS_OK = 1;
  public static final int NC_PROVIDER_STATUS_PREPARATION = 2;
  public static final int NC_PROVIDER_STATUS_BROKEN = 3;

  public NcProvider(long providerCPtr) {
