...
import com.nexuschat.messenger.connect.DcHelper;
...
public class SharingTest {
  ...
  public void testOpenAgainFromRecents() {
    ...
    // In NC, select the same chat you opened before
    onView(withId(R.id.list))
        .perform(
            RecyclerViewActions.actionOnItem(hasDescendant(withText("abc@example.org")), click()));
   ...
   *
   * <p>If you click the email button, Nexus Chat opened but instead of opening a chat with that
